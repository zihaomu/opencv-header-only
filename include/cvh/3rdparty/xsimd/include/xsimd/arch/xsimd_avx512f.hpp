...
namespace xsimd
{
    ...
    namespace kernel
    {
        ...
        {
            return detail::compare_int_avx512f<A, T, _MCV_CMPINT_EQ>(self, other);
        }
        template <class A, class T>
        ...
        {
            return detail::compare_int_avx512f<A, T, _MCV_CMPINT_GE>(self, other);
        }
        ...
        {
            return detail::compare_int_avx512f<A, T, _MCV_CMPINT_GT>(self, other);
        }
...
#undef step1
        ...
        {
            return detail::compare_int_avx512f<A, T, _MCV_CMPINT_LE>(self, other);
        }
        ...
        {
            return detail::compare_int_avx512f<A, T, _MCV_CMPINT_LT>(self, other);
        }
