...
grep -E '^(CVH_BUILD_NATIVE_BACKEND|CVH_BUILD_FULL_BACKEND|CVH_BUILD_BACKEND_KERNEL_SOURCES|CVH_BUILD_LEGACY_XSIMD_TESTS|CVH_BUILD_TESTS|CVH_BUILD_BENCHMARKS|CMAKE_BUILD_TYPE):' "${BUILD_DIR}/CMakeCache.txt" || true
